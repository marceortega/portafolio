    ...
    <div>
      ...
      <div className="layout-main">
        ...
        <div className="titulo_CPT">
          ...
          <p
            className="parrafoInicioCpt"
            data-aos="slide-left"
            data-aos-duration="2000"
          >
            COMIDA PARA TODOS es una fundación que se dedica a combatir la
            escasez de alimentos en la población. Este proyecto de rediseño de
            su página web, lo realizamos con un equipo interdisciplinario, en
            donde la investigación UX fue muy importante.{" "}
          </p>
